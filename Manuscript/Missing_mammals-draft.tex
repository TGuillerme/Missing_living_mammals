...
% NC: Need to add the dates, or date ranges, of your data collection below instead of @
...
% NC: I moved this back up to keep it shorter.
...
% NC: Argh still wrong definition of MNND, I've fixed it myself. It's PAIRWISE!!!
...
% NC: Trying not to piss off GraHam - really it's weird stuff appearing in Carnivora that we are concerned by, not all Carnivora
...
Such an effort would be valuable not only to phylogeneticists, but also to any researcher interested in the diversity of life on Earth.
