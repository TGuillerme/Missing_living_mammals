...
\begin{center}
\input{Supplementary/Supp_data_structureNTI}
\end{center}
\renewcommand\baselinestretch{2}\selectfont

\renewcommand\baselinestretch{1.2}\selectfont
\begin{center}
\input{Supplementary/Supp_data_structurePD}
\end{center}
\renewcommand\baselinestretch{2}\selectfont

\renewcommand\baselinestretch{1.2}\selectfont
\begin{center}
\input{Supplementary/morpho_taxa_proportion_threshold1}
\end{center}
\renewcommand\baselinestretch{2}\selectfont

\renewcommand\baselinestretch{1.2}\selectfont
\begin{center}
\input{Supplementary/Supp_data_structureNRI_threshold1}
\end{center}
\renewcommand\baselinestretch{2}\selectfont

\renewcommand\baselinestretch{1.2}\selectfont
\begin{center}
\input{Supplementary/Supp_data_structureNTI_threshold1}
\end{center}
\renewcommand\baselinestretch{2}\selectfont

\renewcommand\baselinestretch{1.2}\selectfont
\begin{center}
\input{Supplementary/Supp_data_structurePD_threshold1}
\end{center}
\renewcommand\baselinestretch{2}\selectfont
