...
%TG: or actually, along the same lines:
%"Assessment of available anatomical characters for linking living and fossil mammals in phylogenetic analyses"
...
Furthermore, simulations show that fossils are more likely to be placed in clades with for which more characters have been coded, regardless of whether this is the correct clade \cite{GuillermeCooper}.
