...
We suggest that increased morphological data collection efforts for living taxa are needed to produce accurate Total Evidence tip-dated phylogenies. 
\end{abstract}
...
To assess the availability of anatomical characters for each mammalian order and for Mammalia as a class, we calculated the percentage of OTUs with cladistic data at three different taxonomic levels: family, genus and species. %TG: changed cladistic datat to anatomical characters
