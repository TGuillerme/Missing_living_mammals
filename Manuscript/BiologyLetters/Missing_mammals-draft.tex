...
% TG: BIOLOGY LETTERS FORMAT: cut down to 150 words?
...
% TG: BIOLOGY LETTERS FORMAT: Combine paragraph 1 and 2?
...
%TG: I think we can put a lot of that in the supplementaries: the essential is:
% 1-We download matrices
% 2-We selected living OTUs with > 100 characters
% 3-We counted the percentage of available OTUs on Bininda-Emonds tree (low/high coverage)
% 4-We calculated NTI/NRI
...
% TG: YES! Otherwise I think that the text is down to the minimum (we can obviously remove few words here and there)
...
\section{Discussion}
%TG: Again, we can cut a shit load down. The essential would be:
% 1-Not much data is available
% 2-But at least is randomly distributed
% 3-We need to collect more of it
...
% TG: we can maybe remove one or two references (28) but I think we're already at the minimum...
% Reference for now is 685 words. Manuscript should be 1815 words.
