...
table.result(results, metric=c("NRI","NTI"), threshold=c(25,75), save.path="../Manuscript/", file.save="Table_results", caption=caption, environement="longtable", col.threshold=c("blue", "grey", "orange"))
#table.result(results, metric=c("NRI","NTI"), threshold=c(25,75), save.path="../Manuscript/", file.save="Table_results", caption=caption, environement="longtable", col.threshold=c("#2A2A2A","#7F7F7F","#D4D4D4")) #col.threshold=c("#3F3F3F","#7F7F7F","#BFBFBF"))
